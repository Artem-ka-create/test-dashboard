...
interface FormProps {
  ...
  test: { csvData: string; url: string; }; // Structure of the post object
  setTest: (test: { csvData: string; url: string }) => void; // Function to update the post state
  ...
  return (
    <section className='w-full max-w-full flex items-center flex-col'>
      ...
      <p className='desc text-left max-w-md'>
        {type} and Analyse you penetration test
      </p>
